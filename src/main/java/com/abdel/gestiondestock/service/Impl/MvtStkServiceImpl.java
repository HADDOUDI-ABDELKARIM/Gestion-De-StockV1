...
import com.abdel.gestiondestock.model.TypeMvtStk;
import com.abdel.gestiondestock.repository.MvtStkRepository;
import com.abdel.gestiondestock.service.ArticleService;
import com.abdel.gestiondestock.service.MvtStkService;
import com.abdel.gestiondestock.validator.MvtStkValidator;
...
public class MvtStkServiceImpl implements MvtStkService {
    ...
    private MvtStkDto entreePositive(MvtStkDto dto, TypeMvtStk typeMvtStk) {
        ...
        if (!errors.isEmpty()) {
            ...
            throw new InvalidEntityException("Le mouvement du stock n'est pas valide", ErrorCodes.MVT_STK_VALID, errors);
        }
        dto.setQuantite(
                BigDecimal.valueOf(
        ...
        dto.setTypeMvt(String.valueOf(typeMvtStk));
